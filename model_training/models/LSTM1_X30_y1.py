...
class ModelTS:
    ...
    def get_model(self,):
        ...
        # LSTM
        x = LSTM(5, activation='tanh',recurrent_activation="sigmoid", kernel_initializer="glorot_uniform",dropout=0.5, recurrent_dropout=0.0)(input_ecg)
        #x = BatchNormalization()(x)
        # ---------------------------- Dense layer ------------------------------------
        output = Flatten()(x)
        output = Dense(3, kernel_initializer='glorot_normal')(output)
